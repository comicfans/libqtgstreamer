...
void registerValueVTables()
{
    struct ValueVTable_MiniObject
    {
        ...
        {
            *reinterpret_cast<GstMiniObject**>(data) = 
                reinterpret_cast<GstMiniObject*>(g_value_get_boxed(value));
        };
    ...
    struct ValueVTable_Fourcc
    {
        static void get(const QGlib::Value & value, void *data)
        {
            reinterpret_cast<Fourcc*>(data)->value.as_integer = g_value_get_uint(value);
        };

        static void set(QGlib::Value & value, const void *data)
        {
            g_value_set_uint(value, reinterpret_cast<Fourcc const *>(data)->value.as_integer);
        };
    };
    ...
    struct ValueVTable_QDate
    {
        static void get(const QGlib::Value & value, void *data)
        {
            const GDate *gdate = reinterpret_cast<const GDate *>(
